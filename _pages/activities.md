...
* Numerical resolution of L¹ optimal control problems, 2024<br>
  ...
  <a href="https://agustinyabo.github.io/PWLdynamics.jl/stable/" class="btn btn-sm" role="button" target="_blank"><i class="fas fa-code"></i> see online code</a></p>

* Stability analysis of dynamical models through computer algebra, 2023<br>
  <p>From <a href="https://hal.science/hal-03671432">Stability analysis of a bacterial growth model through computer algebra</a><br>
  <a href="https://ct.gitlabpages.inria.fr/gallery/stability/stability.html" class="btn btn-sm" role="button" target="_blank"><i class="fas fa-code"></i> see online code</a></p>

* Simulation and optimal control of a hybrid model of coffee leaf rust propagation, 2021<br>
  <p>From <a href="https://inria.hal.science/hal-03274865">Mathematical modelling and optimal control of the seasonal coffee leaf rust propagation</a><br>
  <a href="https://ct.gitlabpages.inria.fr/gallery/clr/clr.html" class="btn btn-sm" role="button" target="_blank"><i class="fas fa-code"></i> see online code</a></p>

* Optimal control of piecewise linear models, 2021<br>
